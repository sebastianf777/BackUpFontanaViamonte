			...
			<ul class="nav">
				...
				<li class="liLeft active">
					<form target="_self" method="post" action="ver_tabla_pruebas.php" style="height: 46px;">
						...
						<button id="btn" style="font-family: 'PT Serif', serif; margin: 0px; width: 110px; height:47px; color:white ; border-right: grey solid .1px; cursor: pointer;" type="submit" onclick="javascript: form.action='ver_tabla_pruebas.php';">Ver Registros</button>
					</form>
				</li>
			</ul>
		</header>
